 ...
 * [`r fontawesome::fa("r-project")` **avancé :** *outils de développement et de performance*](https://r-dev-perf.borishejblum.science) – *Université de Bordeaux* (2018, 2022)  
    + codes `r fontawesome::fa("r-project")` disponibles [ici](/files/mypkgr_0.0.0.9000.tar.gz)
